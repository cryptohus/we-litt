...
- [ ] 🛠️ **Accessibility pass** — keyboard + VoiceOver sweep (contrast already
      improved; dialogs already have focus-trap/Escape).
- [ ] 🛠️ **Performance check** — the single ~420 KB file over mobile data;
      confirm `sw.js` caches the new `privacy.html`/`terms.html`.
