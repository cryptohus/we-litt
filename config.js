/* We Litt configuration.
 *
 * Leave these empty to run on built-in demo data (the app works fully offline
 * with ~200 sample events). To switch to a live Supabase backend, paste your
